...
exports.publisher = {
    ...
    publishPostMessage: function (postData, action) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const [channel, connection] = yield this.connectRabbitMQ();
                const exchangeName = config_1.MQExchangeName;
                const routingKey = config_1.postServiceProducers[0]; // Specific routing key
    ...
    publishPostMessageToNotification: function (postData, action) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const [channel, connection] = yield this.connectRabbitMQ();
                const exchangeName = config_1.MQExchangeName;
                const routingKey = config_1.postServiceProducers[1]; // Specific routing key
                yield channel.assertExchange(exchangeName, "direct", { durable: true });
                const messageProperties = {
                    headers: {
                        function: action,
    ...
    publishNotificationMessage: function (notificationData, action) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const [channel, connection] = yield this.connectRabbitMQ();
                const exchangeName = config_1.MQExchangeName;
    ...
    publishPostForAdsMessage: function (postData, action) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const [channel, connection] = yield this.connectRabbitMQ();
                const exchangeName = config_1.MQExchangeName;
