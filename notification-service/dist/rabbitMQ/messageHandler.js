        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                switch (operation) {
                    ...
                    case `${config_1.MQActions.addPost}`: {
                        response = yield createPost(data);
                        break;
                    }
                    case `${config_1.MQActions.addNotification}`: {
                        response = yield addNotification(data);
                        break;
                    }
                    default:
...
function createPost(data) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            return yield injection_1.postsService.addPost(data);
        }
        catch (error) {
            throw new Error(error.message);
        }
...
function addNotification(data) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield injection_1.notificationService.addNotification(data);
        }
        catch (error) {
            throw new Error(error.message);
        }
