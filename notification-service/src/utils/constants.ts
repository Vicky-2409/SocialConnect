...
export const MESSAGES = {
  ...
  ERROR_SENDING_LIVE_NOTIFICATION:
    "Error occurred while sending live notification",
  ERROR_ADDING_NOTIFICATION_TO_USER:
    "Error occurred while adding notification to user",
