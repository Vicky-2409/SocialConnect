...
export default {
  ...
  getParticipants: async function (convoId: string) {
    try {
      const res = await apiClient.get(`/participants/${convoId}`);
  ...
  deleteMessage: async function (convoId: string, messageId: string) {
    try {
