...
//                   className="w-full min-h-[120px] p-4 text-gray-700 bg-gray-50 rounded-xl border-2 border-gray-100 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 transition-all duration-200 resize-none"
