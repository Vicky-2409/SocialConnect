...
// import { Sparkles, Star, TrendingUp, BarChart3, Target } from "lucide-react";
...
//               <div className="group relative rounded-2xl overflow-hidden bg-gradient-to-b from-purple-500/5 to-purple-500/10 p-1">
...
// import PayUComponent from "./PayUComponent";
// import { IUser } from "@/types/types";
// import { Sparkles, Star, TrendingUp, BarChart3, Target, ChevronLeft, ChevronRight } from "lucide-react";
...
//               <div className="bg-white/5 rounded-xl p-4 backdrop-blur-sm border border-white/10">
//                 <p className="text-sm text-center text-purple-200/70">
//                   Your boost will be activated immediately after successful payment
//                 </p>
//               </div>
//             </div>
//           </div>
